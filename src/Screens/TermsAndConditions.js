        ...
        <View style={styles.middleContainer}>
          <View style={styles.termContainer}>
            ...
            <Text style={styles.subPoint}>
              ...
              these Terms and Conditions (“Terms”) in full. If you do not agree
          ...
          <View style={styles.termContainer}>
            ...
            <Text style={styles.subPoint}>
              ...
              informational and entertainment purposes. It should not be relied
              upon as a factual source for making dietary or health-related
              decisions. This App is not a substitute for professional medical,
              nutritional, or dietary advice. The App scans and interprets
              ingredient labels on food, personal care- and household products
              but does not guarantee accuracy or completeness of the information
              provided. Always consult with a qualified healthcare professional
              before making any decisions regarding your diet or health.
            </Text>
          </View>
          <View style={styles.termContainer}>
            ...
            <Text style={styles.subPoint}>
              ...
              misuse of the App. The App's information should not be relied upon
              as the sole basis for dietary decisions. We disclaim all
          ...
          <View style={styles.termContainer}>
            ...
            <Text style={styles.subPoint}>
              Users of the App acknowledge that any information provided by the
              App is to be verified independently. We encourage users to read
              food labels carefully and consult official sources or
              professionals for critical dietary or allergy-related information.
            </Text>
          </View>
          <View style={styles.termContainer}>
            <Text style={styles.point}>5. No Warranty</Text>
            <Text style={styles.subPoint}>
              ScanAware is provided “as-is,” without any warranties of any kind,
              either express or implied. We do not guarantee that the App will
              be free from errors, bugs, or inaccuracies, and we are not
              responsible for any incorrect or incomplete information displayed
              in the App.
            </Text>
          </View>
          <View style={styles.termContainer}>
            ...
            <Text style={styles.subPoint}>
              ...
              continuing to use the App after changes are made, you agree to be
